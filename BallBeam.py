...
space.add(wall_shape, wall_body,beam_body, beam_shape, w_b_joint, support_body, support_shape, s_b_joint,armature_body, armature_shape, a_s_joint,ball_body, ball_shape)
